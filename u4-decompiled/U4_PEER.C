...
unsigned char * D_2F72 = &AVATAR[0x1221A + 0x001a]; // {
#if 0
...
short * D_2FF2 = &AVATAR[0x1226D + 0x002e] /* {0x20, 0x06, 0x05, 0x04, 0x24, 0x20, 0x20, 0x0F, 0x54, 0x46, 0x5E, 0x00, 0x0E, 0x0E, 0x02, 0x03} */;
...
/*C_C41D*/CMD_Peer()
{
	u4_puts(/*D_3012*/&AVATAR[0x1228D + 0x002e] /* "Peer at " */);
	if(Party._gems == 0) {
		w_What();
		return 0;
	}
	u4_puts(/*D_301B*/&AVATAR[0x12296 + 0x002e] /* "a Gem!\n" */);
	Party._gems --;
	C_C403();
}
