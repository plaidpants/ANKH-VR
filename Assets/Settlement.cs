...
Varies-0x119 	Varies 	00000....  */
        ...
        for (int height = 0; height < 32; height++)
        {
            for (int width = 0; width < 32; width++)
            {
                ...
                if (tileIndex == 73 || tileIndex == 127 || tileIndex == 57)
                {
                    ...
                    Vector3 location = new Vector3(width, 32 - height, 0.0f);
                ...
                else if (tileIndex >= 96 && tileIndex <= 125)
                {
                    ...
                    Vector3 location = new Vector3(width, 32 - height, 0.25f);
                    mapTile.transform.localPosition = location;
                }
                ...
                else
                {
                    ...
                    if ((tileIndex < 4) || (tileIndex >= 68 && tileIndex <= 71) || ( tileIndex == 76))
                    {
                        ...
                        {
                            location = new Vector3(width, 32 - height, -0.5f);
                        }
                        else
                        {
                            location = new Vector3(width, 32 - height, 0.5f);
        ...
        for (int npcIndex = 0; npcIndex < 32; npcIndex++)
        {
            ...
            if (npcTile != 0)
            {
                ...
                Vector3 npcLocation = new Vector3(npcLocationX, 32 - npcLocationY, 0);
